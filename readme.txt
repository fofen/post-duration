...
Allows you to add a closing date to posts which you can configure to either delete the post, change it to a draft, or private.
This plugin is based on "Post Expirator" by Aaron Axelsen, credits to him. It can be seen as a lite version of it.
